// ============================================================================
// UK CLIMATE LEAFLET VIEWER - ImageOverlay approach (FAST & ALIGNED)
// ============================================================================
...
// Image bounds (from BNG extent converted to lat/lng)
// SW corner: BNG(-199500, -199500) -> lat/lng
// NE corner: BNG(699500, 1249500) -> lat/lng
const IMAGE_BOUNDS = [[49.89, -8.65], [60.85, 1.77]];
...
function updateDisplay() {
    ...
    const imagePath = `leaflet_overlays/${folder}/${currentYear}_${String(currentMonth).padStart(2, '0')}.png`;
    ...
    currentOverlay.on('error', () => {
        ...
        hideLoading();
        alert('Failed to load image. Make sure you ran generate_overlay_images.py');
    });
